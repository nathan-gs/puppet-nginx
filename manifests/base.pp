# Class: nginx::base
#
# Manage nginx base configuration.
# Provide nginx::base::site 
#
# Templates :
#	* nginx/includes/fastcgi_params.erb
#
class nginx::base inherits nginx {

	# Define: nginx::base::site
	#
	# Create a base site config from template using parameters.
	#
	# Parameters :
	...
	#          }
	#
	#         nginx::base::site {"default-ssl":
	#                 listen          => "443",
	#                 root            => "/var/www/nginx-default",
	#                 server_name     => "$fqdn",
	#          }
	define site ( $ensure = 'present', $index = 'index.php', $root, $include = '', $listen = '80', $server_name = '', $access_log = '', $ssl_certificate = '', $ssl_certificate_key = '', $ssl_session_timeout = '5m') { 
		...
		nginx::site {"${name}":
			...
			content	=> template("nginx/base_site.erb"),
		}
